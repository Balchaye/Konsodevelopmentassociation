            ...
            <!--End View of Full Prroject  -->
                      ...
                      -->
                                    ...
                                    <?php
                                         include('includes/config.php');
                                        if($_POST['project_edit'])
                                        {
                                        $Title=$_POST['Title'];
                                        $Project_introduction=$_POST['Project_introduction'];
                                       // $coursefn=$_POST['cnf'];
                                        $ProjectCode=$_GET['id'];
                                        $query="update projecttable set Title ='$Title',Project_introduction='$Project_introduction' where ProjectCode='$ProjectCode'";
                                    ...
                                    <?php	
                                    $id=$_GET['id'];
                                    $ret="select * from  projecttable where ProjectCode='$id'";
                                    $stmt= $mysqli->prepare($ret) ;
                                    // $stmt->bind_param($id);
                                    $stmt->execute() ;//ok
                                    $res=$stmt->get_result();
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="ProjectCode"  value="<?php echo $row->ProjectCode;?>" disabled class="form-control" > 
                                    <font color="red">Project Code Can not be Edited!!</font> 
                                    <p></p>
                                    <label class="col-sm-2 control-label">Project Donor Code&nbsp;&nbsp;&nbsp;</label>
                                    <input type="text"  name="ProjectCode"  value="<?php echo $row->ProjectDonor;?>" disabled class="form-control" > 
                                    <font color="red">Project Donor Code Can not be Edited!!</font>
                                </div>
                                    <p></p>
                                    <label class="col-sm-2 control-label">Project Tile&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <div class="col-sm-8">
                                    <input type="text"  name="Title" value="<?php echo $row->Title;?>"  class="form-control"> </div>
                                    </div>
                                    <div class="form-group">
                                    <label class="col-sm-2 control-label">Project Body</label>
                                    <div class="col-sm-8">
                                    <textarea type="text" class="form-control" name="Project_introduction" id="Project_introduction" value="<?php echo $row->Project_introduction;?></textarea>
                                    ...
                                    <input class="btn btn-primary" type="submit" name="project_edit" value="Update Project Details">
