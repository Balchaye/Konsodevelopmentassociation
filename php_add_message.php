  ...
  <div class="main">
    ...
    <div class="content">
      ...
      if (isset($_POST['addmessage'])){
        ...
        $queryi = "SELECT * FROM adminstrator WHERE Username = '$id'  or die (mysql_error()) "; 
  ...
  echo '<div class="alert alert-dismissable alert-success">';
    ...
    ?>   
        ...
        <table border="1px solid silver" cellpadding="15px" cellspacing="10px"
          ...
          $resulti = "select * from message where message_id = '$_GET[messid]'";
          $result = $conn->query($resulti);
          while($row=mysqli_fetch_array($result))
          {

                echo "<tr>"; 
                echo"<td>"."Message Posted By:- ".$row['Username']."</td>";
                echo"</tr>";
