    ...
    <div class="content">
      <div class="content_resize">
        ...
        <ul class="sb_menu">
          ...
          $resulti = "select * from message ORDER BY PostTime DESC ";
          $result = $conn->query($resulti);
          while($row=mysqli_fetch_array($result))
          {
            $user=$row['Username'];
            $result1i= "select *from adminstrator where Username='$user'";
            $result1 = $conn->query($result1i);
            $row1=mysqli_fetch_array($result1);
            echo"<table style=' border:4px solid silver' cellpadding='15px' cellspacing='10px'
            align='center' border='0' >"; 
            echo "<tr>"; 
            echo"<td>"."<font size='4'>"."Message From KDA ".$row1['UserType']."</font>"."</td>";
            echo"</tr>"; 
            echo "<tr>"; 
            echo "<td>"."<img style='margin-top:-10px; border-width: 0px; margin-left:4px;'  width=145 height=137 alt='Unable to View' 
              src='" .$row1['profileimage'] ."' >";
            echo "<font size='4'>".$row1['FirstName']." ".$row1['FatherName']." ".$row1['GFaName']." "."[".$row1['UserType']."]"."</font>"."</td>";
            echo"</tr>";
            echo"<tr>";    
            echo "<tr>"; 
            echo"<td>"."<font size='4'>"."Phone:-".$row1['PhoneNumber']."</font>"."</td>";
            echo"</tr>";       
                  echo"<td>"."<strong>".  "Posted on ".$row['PostTime']. "</strong>"."</td>";     
                echo "<tr>"; 
  ...
  <font size="3">
            ...
            $db="kda";
            $conn =new mysqli('localhost', $user, $pass, $db) or die("Unable to connect");
            echo"<font size=4.5>"."<strong>"."List of ongoing Projects under Konso Development Association(KDA)"." </strong>"."</font>". "<p>"."</p>".
            ...
            . $interval->m." months, ".$interval->d. " days ".$interval->h. " hour "
              ...
              <p><a href="php_home_out.php?del=<?php echo $row->ProjectCode;?>" title="View About The Project" onclick=";">
            ...
            <?php
                    ...
                    /* 
                    {
                      $hadaraw=("UPDATE projecttable SET PView = PView+1 where ProjectCode = '$_GET[del]'");	
                      if(!mysql_query($hadaraw,$con)){
